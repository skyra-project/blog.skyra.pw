...
_Note that most of Skyra will be preserved and relocated to another bot, be it ours or a third party, but some modules may radically change._
...
We'll make a central website for all bots where specific bot functionality is divided into separate paths. [skyra.pw](https://skyra.pw) will be a landing section with information for each bot in the network - this way, users are also exposed to the other bots, which might spark some curiosity.
